...
import dev.xcolorful.customgun.core.api.minecraft.tab.AmmoTab;
import dev.xcolorful.customgun.core.api.minecraft.tab.AttachmentTab;
import dev.xcolorful.customgun.core.api.minecraft.tab.GunTab;
