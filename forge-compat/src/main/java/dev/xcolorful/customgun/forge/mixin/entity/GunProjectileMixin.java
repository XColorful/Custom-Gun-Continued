package dev.xcolorful.customgun.forge.mixin.entity;
...
/**
 * <ul>
 *     <li>让 {@link GunProjectile} 在 Forge 下实现 {@link IEntityAdditionalSpawnData}</li>
 ...
 *     <li>因此必须在 {@link GunProjectile} 上通过 Mixin 实现该接口，而非依赖 {@link ForgeGunProjectile} 拦截注册</li>
 * </ul>
 */
