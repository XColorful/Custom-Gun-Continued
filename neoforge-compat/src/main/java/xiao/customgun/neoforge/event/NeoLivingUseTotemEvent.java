...
import xiao.customgun.core.api.event.ILivingUseTotemEvent;
import xiao.customgun.core.api.minecraft.CommandLevel;

public class NeoLivingUseTotemEvent extends NeoEvent implements ILivingUseTotemEvent {

    protected LivingUseTotemEvent livingUseTotemEvent;

    public NeoLivingUseTotemEvent(Event event) {
        super(event);
