...
public interface ISneakInaccuracyModifier<T extends ResourcePojo<T>> extends IGunModifier<T, _SimpleModifierData, Float> {
...
//        if (fireModeAdjust != null) base += fireModeAdjust.getOtherInaccuracy();
    ...
    static @NotNull Float evalByScript(GunScriptApi scriptApi, @NotNull Float value) {
        return scriptApi.getIGun().evalByScript(scriptApi.getGunItem(), scriptApi, GunModifierType.SNEAK_INACCURACY, value);
    }
}
