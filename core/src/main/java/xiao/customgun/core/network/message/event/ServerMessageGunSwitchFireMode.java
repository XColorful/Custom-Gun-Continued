...
import xiao.customgun.client.network.message.event._ServerMessageGunSwitchFireMode;
...
public record ServerMessageGunSwitchFireMode(int shooterId,
    ...
    @Override
    public void handle(ServerMessageGunSwitchFireMode message, Consumer<Runnable> handler, NetworkContext context) {
