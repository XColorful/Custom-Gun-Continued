...
package dev.xcolorful.customgun.core.resource.data.script;
...
public final class DataScript extends ResourceFile<DataScript> {
    ...
    public static void toFile(OutputStream outputStream, DataScript file) throws UnsupportedOperationException, IOException {
