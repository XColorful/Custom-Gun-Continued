...
public class _ControllableData extends ResourcePojo<_ControllableData> {
    ...
    @Override
    protected _ControllableData fromJsonReader(JsonReader reader) throws IOException {
        _ControllableData pojo = new _ControllableData();
        reader.beginObject(); {
    ...
    public static void toJson(JsonWriter writer, _ControllableData pojo) throws IOException {
