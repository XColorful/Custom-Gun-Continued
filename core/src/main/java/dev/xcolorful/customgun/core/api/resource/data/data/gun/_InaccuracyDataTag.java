...
import dev.xcolorful.customgun.core.api.entity.ShootStateTag;

public class _InaccuracyDataTag {

    public static final String STAND = ShootStateTag.STAND;
    public static final String MOVE = ShootStateTag.MOVE;
    public static final String RIDE = ShootStateTag.RIDE;
