...
public final class ShooterGunPropertyCacheEvent extends LivingShooterEvent implements IGunEvent {
    ...
    private final @NotNull ShooterGunPropertyCache cache;

    public ShooterGunPropertyCacheEvent(McLogicalSide logicalSide,
    ...
    @Override public CustomEventType getEventType() {
        return CustomEventType.SHOOTER_GUN_PROPERTY_CACHE_EVENT;
    }
    ...
    public @NotNull ShooterGunPropertyCache getCache() {
        return this.cache;
    }

    @Override public String getTextName() {
        return this.livingShooter != null ? this.livingShooter.getName().getString()
                : "ShooterGunPropertyCacheEvent";
    }
    ...
    private static final EventDispatcher<ICustomEventHandler, ICustomEvent, CustomEventType> _EVENT_DISPATCHER = CustomGun.getEventPoster().getEventDispatcher(ShooterGunPropertyCacheEvent.class);
