...
import dev.xcolorful.customgun.client.renderer.shooter.FirstPersonRender;
...
public class ClientEventHandlers {
    ...
    public static void registerAll(ICustomEventRegister customEventRegister) {
        ...
        CoreEventHandlers.register(customEventRegister, FirstPersonRender.get(), EventType.RENDER_HAND_EVENT, EventPriority.NORMAL, false);
