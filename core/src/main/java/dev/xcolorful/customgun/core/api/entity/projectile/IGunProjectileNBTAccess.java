...
public interface IGunProjectileNBTAccess extends IGunProjectileValueAccess {
     ...
     */
    @NotNull Identifier getGunLocation(CompoundTag gunProjectileCustomDataTag);
    void setGunLocation(CompoundTag gunProjectileCustomDataTag, Identifier gunLocation);
    /**
     * 获取NBT指定的GunDisplay，如无则返回 {@link ResourceTag#NULL_LOCATION}
     */
    @NotNull Identifier getGunDisplayLocation(CompoundTag gunProjectileCustomDataTag);
    void setGunDisplayLocation(CompoundTag gunProjectileCustomDataTag, Identifier gunDisplayLocation);
    /**
     * 获取子弹ID，如不存在则返回 {@link ResourceTag#NULL_LOCATION}
     */
    @NotNull Identifier getAmmoLocation(CompoundTag gunProjectileCustomDataTag);
    void setAmmoLocation(CompoundTag gunProjectileCustomDataTag, Identifier ammoLocation);
