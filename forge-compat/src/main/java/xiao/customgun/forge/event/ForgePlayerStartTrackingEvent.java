...
import xiao.customgun.core.api.event.IPlayerStartTrackingEvent;
import xiao.customgun.core.api.minecraft.CommandLevel;

public class ForgePlayerStartTrackingEvent extends ForgeEvent implements IPlayerStartTrackingEvent {

    protected PlayerEvent.StartTracking startTrackingEvent;

    public ForgePlayerStartTrackingEvent(Event event) {
        super(event);
