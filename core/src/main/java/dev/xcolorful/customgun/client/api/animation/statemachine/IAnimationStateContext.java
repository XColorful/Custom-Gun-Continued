...
public interface IAnimationStateContext<T extends AnimStateContext> {
     ...
     * 触发状态转移进入此状态时调用
     * @param context 状态上下文，承载状态行为可能需要的各种参数
     * @see AnimStateMachine#trigger(java.lang.String)
     */
     ...
     * @see AnimStateMachine#trigger(java.lang.String)
     */
    IAnimationStateContext<T> transition(T context, String condition);
}
