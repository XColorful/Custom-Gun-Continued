...
//    private float @Nullable [] cgc$firstPersonRenderOffset;
    ...
    @Override public void setGunLocation(Entity gunProjectile, Identifier gunLocation) {
    ...
    @Override public void setGunDisplayLocation(Entity gunProjectile, Identifier gunDisplayLocation) {
    ...
    @Override public void setAmmoLocation(Entity gunProjectile, Identifier ammoLocation) {
