...
/**
 * 射手生物{@link ILivingShooter} 检视事件
 */
public class ShooterInspectEvent extends LivingShooterEvent implements IGunEvent {

    private final @Nullable IGun iGun;
    private final @NotNull ItemStack gunItem;

    public ShooterInspectEvent(McLogicalSide logicalSide,
    ...
    @Override public CustomEventType getEventType() {
        return CustomEventType.SHOOTER_INSPECT_EVENT;
    }
    ...
    private static final EventDispatcher<ICustomEventHandler, ICustomEvent, CustomEventType> _EVENT_DISPATCHER = CustomGun.getEventPoster().getEventDispatcher(ShooterInspectEvent.class);
