...
public class MuzzleFlashRender implements IModelComponentRenderer {
    ...
    private void doRender(int light, int overlay, long currentTimeMillis, _MuzzleFlashDisplay muzzleFlashDisplay) {
        ...
        poseStack2.pushPose(); {
            ...
            MUZZLE_FLASH_MODEL.renderToBuffer(poseStack2, multiBufferSource.getBuffer(renderTypeBg), light, overlay, -1);
        }
        poseStack2.popPose();
        ...
        poseStack2.pushPose(); {
            ...
            MUZZLE_FLASH_MODEL.renderToBuffer(poseStack2, multiBufferSource.getBuffer(renderTypeLight), light, overlay, -1);
        }
        poseStack2.popPose();
    }
