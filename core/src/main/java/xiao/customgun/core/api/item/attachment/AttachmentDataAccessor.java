...
public interface AttachmentDataAccessor extends AttachmentNBTAccessor, IAttachmentDataAccess {
    ...
    @Override
    default @NotNull Identifier getAttachmentLocation(ItemStack attachmentItem) {
    ...
    @Override
    default void setAttachmentLocation(ItemStack attachmentItem, Identifier attachmentLocation) {
        var customData = NBTUtils.getCustomData(attachmentItem);
