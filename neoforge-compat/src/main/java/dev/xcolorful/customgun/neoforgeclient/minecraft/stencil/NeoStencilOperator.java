...
public class NeoStencilOperator implements IStencilOperator {
    ...
    /**
     * 1.21.10 移除了 RenderSystem 上的 enableStencil/disableStencil，模板测试改由 {@link Object} 携带。
    ...
    /**
     * 缓存“基础管线 + 模板测试 -> 注入模板后的管线”，保证同一个 {@link Object} 对象被复用，
     * 否则 {@code GlDevice#pipelineCache}（IdentityHashMap）每次都会重新编译管线。
     */
    private static final Map<Object, Map<Object, Object>> STENCIL_PIPELINE_CACHE = new IdentityHashMap<>();
    ...
    @ApiStatus.AvailableSince("1.21.10")
    @ApiStatus.Internal
    public static Object applyStencilToPipeline(Object pipeline) {
        return null;
    }
}
