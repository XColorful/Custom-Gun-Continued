...
public final class GunUpgradesTipPart implements GunTooltipPart {
    public static final GunUpgradesTipPart INSTANCE = new GunUpgradesTipPart();
    private GunUpgradesTipPart() {}
