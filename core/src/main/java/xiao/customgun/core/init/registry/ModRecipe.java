...
public class ModRecipe {
    ...
    // 类加载顺序会保证在 ↑调用 前执行
    public static final IRegistryObject<RecipeSerializer<?>> TACZ_TABLE_RECIPE_SERIALIZER = RECIPE_SERIALIZERS.register(CustomRecipeType.TACZ_TABLE_RECIPE.getTagName(),
