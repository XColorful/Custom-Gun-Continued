...
package dev.xcolorful.customgun.core.resource.data.recipe.recipe.ingredient;

import com.google.gson.stream.JsonReader;
import com.google.gson.stream.JsonWriter;
import dev.xcolorful.customgun.core.api.resource.ResourceTag;
import dev.xcolorful.customgun.core.api.resource.data.recipe.recipe.ingredient._IngredientFilterDataTag;
...
public final class _IngredientFilterData extends ResourcePojo<_IngredientFilterData> {
    ...
    private @Nullable ResourceLocation itemFilterLocation;
    private @Nullable ResourceLocation tagFilterLocation;
    ...
    public @Nullable ResourceLocation getItemFilterLocation() {
        return itemFilterLocation;
    }
    public @Nullable ResourceLocation getTagFilterLocation() {
