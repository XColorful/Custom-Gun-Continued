...
|---|---|
|message.event.`ServerMessageGunDraw`|message.shooter.`S2CMessageShooterDraw`|
|message.event.`ServerMessageGunFire`|message.gun.`S2CMessageGunFire`|
|message.event.`ServerMessageGunFireSelect`|message.shooter.`S2CMessageShooterSwitchFireMode`|
|message.event.`ServerMessageGunHurt`|message.projectile.`S2CMessageProjectileHit`|
|message.event.`ServerMessageGunKill`|message.projectile.`S2CMessageProjectileKill`|
|message.event.`ServerMessageGunMelee`|message.shooter.`S2CMessageShooterMelee`|
|message.event.`ServerMessageGunReload`|message.shooter.`S2CMessageShooterReload`|
|message.event.`ServerMessageGunShoot`|message.shooter.`S2CMessageShooterShoot`|
|message.handshake.`Acknowledge`|message.handshake.`C2SMessageAcknowledge`|
|message.handshake.`ServerMessageSyncedEntityDataMapping`|message.handshake.`S2CMessageSyncedEntityDataMapping`|
|message.`ClientMessageCraft`|message.player.`C2SMessagePlayerCraft`|
|message.`ClientMessageLaserColor`|message.shooter.`C2SMessageShooterRefit_laserColor`|
|message.`ClientMessagePlayerAim`|message.shooter.`C2SMessageShooterAim`|
|message.`ClientMessagePlayerBoltGun`|message.shooter.`C2SMessageShooterBolt`|
|message.`ClientMessagePlayerCancelReload`|message.shooter.`C2SMessageShooterReload_cancel`|
|message.`ClientMessagePlayerCrawl`|message.`ClientMessagePlayerProne`|
|message.`ClientMessagePlayerDrawGun`|message.shooter.`C2SMessageShooterDraw`|
|message.`ClientMessagePlayerFireSelect`|message.shooter.`C2SMessageShooterSwitchFireMode`|
|message.`ClientMessagePlayerMelee`|message.shooter.`C2SMessageShooterMelee`|
|message.`ClientMessagePlayerReloadGun`|message.shooter.`C2SMessageShooterReload`|
|message.`ClientMessagePlayerShoot`|message.shooter.`C2SMessageShooterShoot`|
|message.`ClientMessagePlayerZoom`|message.shooter.`C2SMessageShooterZoom`|
|message.`ClientMessageRefitGun`|message.shooter.`C2SMessageShooterRefit_install`|
|message.`ClientMessageSyncBaseTimestamp`|message.shooter.`C2SMessageShooterBaseTimestamp`|
|message.`ClientMessageUnloadAttachment`|message.shooter.`C2SMessageShooterRefit_unload`|
|message.`ServerMessageCraft`|message.player.`S2CMessagePlayerCraft`|
|message.`ServerMessageLevelUp`|message.gun.`S2CMessageGunLevelUp`|
|message.`ServerMessageRefreshRefitScreen`|message.shooter.`S2CMessageShooterRefit_refresh`|
|message.`ServerMessageSound`|message.resource.`S2CMessageResourceSound`|
|message.`ServerMessageSwapItem`|message.player.`S2CMessagePlayerSwapItem`|
|message.`ServerMessageSyncBaseTimestamp`|message.shooter.`S2CMessageShooterBaseTimestamp`|
|message.`ServerMessageSyncGunPack`|message.resource.`S2CMessageSyncDataPack`|
|message.`ServerMessageUpdateEntityData`|message.sync.`S2CMessageUpdateEntityData`|
