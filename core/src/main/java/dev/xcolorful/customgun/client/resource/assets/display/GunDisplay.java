...
public final class GunDisplay extends _AssetsDisplay<GunDisplay> {
    ...
    // 材质
    private @Nullable Identifier hudTextureLocation;
    private @Nullable Identifier hudEmptyTextureLocation;
    ...
    private @Nullable Identifier scriptLocation;
    ...
    public @Nullable Identifier getHudTextureLocation() {
        return hudTextureLocation;
    }
    public @Nullable Identifier getHudEmptyTextureLocation() {
    ...
    public @Nullable Identifier getScriptLocation() {
    ...
    public void setHudTextureLocation(Identifier hudTextureLocation) {
        this.hudTextureLocation = hudTextureLocation;
    }
    public void setHudEmptyTextureLocation(Identifier hudEmptyTextureLocation) {
    ...
    public void setGunAnimationLocation(Identifier gunAnimationLocation) {
        this.gunAnimationLocation = gunAnimationLocation;
    }
    public void setScriptLocation(Identifier scriptLocation) {
    ...
    public void setPlayerAnimatorLocation(Identifier playerAnimatorLocation) {
