...
import xiao.customgun.core.resource.data.recipe.recipe.result._ResultItemData;
...
public final class _TableResultData extends ResourcePojo<_TableResultData> {
     ...
     */
    private @Nullable Identifier pojoLocation;
    ...
    public @Nullable Identifier getTabGroupLocation() {
        return tabGroupLocation;
    }
    public @Nullable Identifier getPojoLocation() {
        return pojoLocation;
    }
    ...
    public void setTabGroupLocation(Identifier tabGroupLocation) {
        this.tabGroupLocation = tabGroupLocation;
    }
    public void setPojoLocation(Identifier pojoLocation) {
