...
/**
 * 射手生物{@link ILivingShooter} 射击事件
 */
public final class ShooterFireEvent extends LivingShooterEvent implements IGunEvent {

    private final @Nullable IGun iGun;
    private final @NotNull ItemStack gunItem;

    public ShooterFireEvent(McLogicalSide logicalSide,
    ...
    @Override public CustomEventType getEventType() {
        return CustomEventType.SHOOTER_FIRE_EVENT;
    }
    ...
    private static final EventDispatcher<ICustomEventHandler, ICustomEvent, CustomEventType> _EVENT_DISPATCHER = CustomGun.getEventPoster().getEventDispatcher(ShooterFireEvent.class);
